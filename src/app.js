(function () {
    /* globals Phaser:false, MonsterGame:false */
    ...
    game.state.add('Boot', MonsterGame.Boot);
    game.state.add('Preload', MonsterGame.Preload);
    game.state.add('Game', MonsterGame.Game);
